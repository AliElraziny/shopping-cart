...
<body>
	...
	<div class="container">
		<div class="d-flex py-3">
			...
			<a class="mx-3 btn btn-primary" href="#">Check out</a></a>
		</div>
						...
						if(cart_list !=null){
							...
							for(Cart c:cartProduct){ %>
								...
								<tr>
									...
									<td>
										<form action="order-now" class="form-inline">
											...
											<div class="form-group d-flex justify-content-between w-50">
												<a class="btn btn-sm btn-incre" href="quantity-incr-decr?action=dec&id=<%=c.getId() %>"><i
													class="fas fa-minus-square"></i></a> <input type="text"
													name="quantity" value="<%=c.getQuantity() %>" class="form-control w-50" readonly>
									...
									<td><a class=" btn btn-sm btn-danger" href="remove-from-cart?id=<%=c.getId()%>">Remove</a></a></td>
